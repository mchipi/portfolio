  ...
  return (
    <footer className="border-t border-ink/20 mt-24 md:mt-32">
      <div className="mx-auto max-w-6xl px-6 md:px-10 py-10 md:py-14">
        ...
        <p className="mt-8 font-utility text-xs text-ink/70 relative inline-flex items-center gap-1.5">
          {profile.footerSignoff}
          <Annotation variant="asterisk" className="w-3 h-3 inline-block" />
        </p>
      </div>
    </footer>
  )
